...
namespace AthenaEngine.Framework.Gameplay
{
    ...
    public class Character : DrawableEntity, IFocusable
    {
        ...
        public Character(Vector2 position, Vector2 size, SpriteBatch spriteBatch, Texture2D texture, Level level) : base(position, size, new Rectangle(0, 0, 25, 25), spriteBatch, texture, level)
        {
